    ...
    <a-spin :spinning="loading">
      <a-form-model ref="form" :model="entity" :rules="rules" v-bind="layout">
        <a-form-model-item label="上级菜单" prop="ParentId">
          <TreeSelect v-model="entity.ParentId" table="Bas_SkuType" :allowClear="true"></TreeSelect>
        </a-form-model-item>
...
import MainSvc from '@/api/Bas/Bas_SkuTypeSvc'
...
export default {
  ...
  methods: {
    ...
    init() {
      this.loading = false
      this.visible = true
      this.entity = { Id: '', WhseId: this.defaultWhseId, ParentId: null, Name: '', Code: '' }
      this.$nextTick(() => {
