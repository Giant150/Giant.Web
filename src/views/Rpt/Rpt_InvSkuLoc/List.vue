<template>
  <a-card :bordered="false">
    ...
    <s-table ref="table" size="default" rowKey="LocId" :columns="columns" :data="loadData" :rowSelection="rowSelection" showPagination="auto">
...
import MainSvc from '@/api/Rpt/Rpt_InvSkuLocSvc'
...
export default {
  ...
  data() {
    ...
    return {
      ...
      advanced: false,
      // 查询参数
      queryParam: { WhseId: '', StorerId: '', LocId: '', SkuId: '' },
      ...
      loadData: parameter => {
        ...
        const requestParameters = Object.assign({ sortField: 'LocCode', sortOrder: 'asc', Search: _query }, parameter)
  ...
  methods: {
    ...
    resetSearchForm() {
      this.queryParam = { WhseId: this.defaultWhseId, StorerId: this.defaultStorerId, LocId: '', SkuId: '' }
    },
    handleExport() {
      this.queryParam.WhseId = this.defaultWhseId
      var _query = Object.assign({}, { ...this.queryParam })
